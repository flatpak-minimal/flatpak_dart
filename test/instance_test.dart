...
//   branch="stable" commit="deadbeef"
//   runtime="runtime/org.gnome.Platform/x86_64/50"
//   pid=1234 childPid=1240 isRunning=true
...
final _goldenFpInstance = Uint8List.fromList(<int>[
  ...
  0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6f, 0x72,
  0x67, 0x2e, 0x67, 0x6e, 0x6f, 0x6d, 0x65, 0x2e, 0x43, 0x61,
  0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72,
  // instanceId = "42"
  0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x34, 0x32,
  // arch = "x86_64"
  0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x38,
  0x36, 0x5f, 0x36, 0x34,
  // branch = "stable"
  0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x73, 0x74,
  0x61, 0x62, 0x6c, 0x65,
  // commit = "deadbeef"
  0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x65,
  0x61, 0x64, 0x62, 0x65, 0x65, 0x66,
  // runtime = "runtime/org.gnome.Platform/x86_64/50"
  0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x72, 0x75,
  0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2f, 0x6f, 0x72, 0x67, 0x2e,
  0x67, 0x6e, 0x6f, 0x6d, 0x65, 0x2e, 0x50, 0x6c, 0x61, 0x74,
  0x66, 0x6f, 0x72, 0x6d, 0x2f, 0x78, 0x38, 0x36, 0x5f, 0x36,
  0x34, 0x2f, 0x35, 0x30,
  // pid = 1234
  0xd2, 0x04, 0x00, 0x00,
  // childPid = 1240
...
void main() {
  ...
  group('FpInstance wire format', () {
    test('decodes the C++ golden buffer', () {
      ...
      expect(inst.runtime, 'runtime/org.gnome.Platform/x86_64/50');
      expect(inst.pid, 1234);
      expect(inst.childPid, 1240);
      expect(inst.isRunning, isTrue);
    });
    ...
    test('golden buffer is exactly the payload the C++ writer emits', () {
      // 135 payload bytes + the 1-byte discriminator.
      expect(_goldenFpInstance.length, 136);
    });
  });
}
