...
template<> struct glz::meta<FlatpakRef> {
    static constexpr auto fields = std::make_tuple(
        glz::field("kind",         &FlatpakRef::kind),
        glz::field("name",         &FlatpakRef::name),
        glz::field("arch",         &FlatpakRef::arch),
        glz::field("branch",       &FlatpakRef::branch),
...
template<> struct glz::meta<InstalledApp> {
    static constexpr auto fields = std::make_tuple(
        glz::field("ref",            &InstalledApp::ref),
        glz::field("origin",         &InstalledApp::origin),
...
template<> struct glz::meta<FlatpakRemoteInfo> {
    static constexpr auto fields = std::make_tuple(
        glz::field("name",          &FlatpakRemoteInfo::name),
        glz::field("url",           &FlatpakRemoteInfo::url),
...
template<> struct glz::meta<RemoteConfig> {
    static constexpr auto fields = std::make_tuple(
        glz::field("url",           &RemoteConfig::url),
        glz::field("title",         &RemoteConfig::title),
...
template<> struct glz::meta<TransactionProgress> {
    static constexpr auto fields = std::make_tuple(
        glz::field("op",               &TransactionProgress::op),
        glz::field("ref",              &TransactionProgress::ref),
